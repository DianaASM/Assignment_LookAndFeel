...
function updateFish(val)
{
    ...
    switch (sb.selectedIndex)
    {
        ...
        case 1:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: Damselfish are those within the subfamilies Abudefdufunae, Chrominae, Lepidozyginae, Pomacentrinae, and Stegastanae within the family Pmacentridae. They can be aggressive and very territorial. They exhibit filial Cannibalism consuming over 25% of its clutches.";
            break;
        case 2:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: Chromis is a species of damselfish and tend to be iridescen apple-green and light blue. It is not recommended to house green chromis with larger predatory fishe as they may become food themselves..";
            break;
        case 3:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: Bicolor Blenny are part of the Blenny family. Bleenies demonstrate mimicry of other species.";
            break;
        case 4:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: Given their small size, their diet consists mainly of mesoplankton. They are opportunistic feeders, not hunters. Because of territorial issues with their own kind in the small confines of a tank, they are best kept singly or as a breeding pair.";
            break;
        case 5:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: It is also known as Yellow Prawn-gobby. It is often kept in salt water aquariums. This species is symbiotic with alpheid shrimps. And are often partnered with Tiger pistol shrimp.";
            break;
        case 6:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: Growing in aquaria, they should be fed two times per day. They are considered reef safe and are peaceful and sociable. They will also make schools if many are put into a tank.";
            break;
        case 7:
            document.getElementById('quickInfo').innerHTML = "Quick Info: Hardy, doesn't need a big tank";
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: Hawkfishes are a family of ray-finned fishes. Since these are too small in an aquarium are use mainly for food fish.";
            break;
        case 8:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: It is also known as Maiden Goby or the Orange Spotted Sleeper Goby. They are often found in pairs that are thought to be monogamous. A large live sand bed is very important since these gobies rely on it for food.";
            break;
        case 9:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: This is a secretive and shy species which is normally encountered in small, loose groups swimming among the branches of corals for protection. It feeds mainly on small crustaceans. This is a diurnal species which takes shelter in cavities where it creates a mucus cocoon in which to sleep during the night, it is thought that this cocoon helps protect it from nocturnal predators by masking the scent of the sleeping fish.";
            break;
        case 10:
        ...
        case 11:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: Also known as Twospined anglefish or dusky anglefish is a member of the Pomacanthidae family. They live in small social groups consisting of a single male and a few females. They are protogynous hermaphrodites and the most dominant of the females in a group will change sex to become male if the existing male dies or disappears. This species feeds on algae and detritus.";
            break;
        case 12:
            ...
            document.getElementById('AdditionalInfo').innerHTML = "Additional Info: The dottybacks are a family Pseudochromidae . Many species are brightly coloured fish, often showing striking sexual dimorphism. They are aggressibely territorial.";
            break;
        case 13:
